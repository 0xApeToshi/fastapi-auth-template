...
class UserRepository:
    ...
    async def update(self, user_id: int, user_update: UserUpdate, hashed_password: Optional[str] = None) -> Optional[User]:
        """
        Update a user.
    ...
    async def update_refresh_token(self, user_id: int, refresh_token: Optional[str], expires_at: Optional[datetime] = None) -> bool:
        """
